...
export default function RolePagination({ currentPage, totalPages, onPageChange }: RolePaginationProps) {
          ...
          <div key={page} className="flex items-center gap-2">
            ...
            <button
              ...
              className={`h-9 min-w-9 rounded-lg px-3 text-sm font-semibold transition ${
                page === currentPage ? 'bg-blue-600 text-white' : 'border border-slate-200 text-slate-700 hover:bg-slate-50'
              }`}
            >
              {page + 1}
            </button>
