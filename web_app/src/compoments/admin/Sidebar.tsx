...
function RoleIcon({ className }: MenuIconProps) {
  return (
    <svg className={className} width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 3L20 7V12C20 17 16.5 20.5 12 22C7.5 20.5 4 17 4 12V7L12 3Z" stroke="currentColor" strokeWidth="1.8" />
...
const menuItems = [
  ...
  { label: 'Role Management', to: '/admin/roles', icon: RoleIcon },
